...
# Add or remove versions as needed based on Adan compatibility.
# Adan requires PyTorch and supports a wide range of versions.
ADAN_SUPPORTED_TORCH_VERSIONS = [
    "2.4.1",
    "2.5.1",
    "2.6.0",
    "2.7.1",
...
def main() -> None:
    ...
    for target_arch, torch_versions in ARCH_TORCH_PAIRS.items():
        for torch_version in torch_versions:
            if torch_version not in ADAN_SUPPORTED_TORCH_VERSIONS:
                continue
